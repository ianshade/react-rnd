...
ava_1.default("dragging with offset", function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var onDrag, rnd;
    return __generator(this, function (_a) {
        onDrag = sinon_1.spy();
        rnd = enzyme_1.mount(React.createElement("div", { style: { margin: '100px 60px' } },
            React.createElement(_1.Rnd, { id: 'rnd', onDrag: onDrag, default: { x: 100, y: 100, width: 100, height: 100 } })), {
            attachTo: document.querySelector("div"),
        });
