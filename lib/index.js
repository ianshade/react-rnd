...
var Rnd = /** @class */ (function (_super) {
    ...
    Rnd.prototype.onDrag = function (e, data) {
        if (this.props.onDrag) {
            ...
            return this.props.onDrag(e, __assign(__assign({}, data), { x: data.x + left, y: data.y + top_3 }));
        }
    };
    Rnd.prototype.onDragStop = function (e, data) {
        if (this.props.onDragStop) {
            var _a = this.offsetFromParent, left = _a.left, top_4 = _a.top;
            return this.props.onDragStop(e, __assign(__assign({}, data), { x: data.x + left, y: data.y + top_4 }));
        }
    };
